...
Source0  : https://files.pythonhosted.org/packages/fb/ab/38a0e94cb01dacb50f06957c2bed1c83b8f9dac6618988a37b2487862944/matplotlib-3.8.2.tar.gz
...
%prep
%setup -q -n matplotlib-3.8.2
cd %{_builddir}/matplotlib-3.8.2
pushd ..
cp -a matplotlib-3.8.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1701098821
