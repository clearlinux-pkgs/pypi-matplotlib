...
Source0  : https://files.pythonhosted.org/packages/65/c2/34158ff731a12802228434e8d17d2ebb5097394ab9d065205cc262cf2a6f/matplotlib-3.7.0.tar.gz
...
%prep
%setup -q -n matplotlib-3.7.0
cd %{_builddir}/matplotlib-3.7.0
pushd ..
cp -a matplotlib-3.7.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1677259797
