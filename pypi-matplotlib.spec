...
Source0  : https://files.pythonhosted.org/packages/9a/aa/607a121331d5323b164f1c0696016ccc9d956a256771c4d91e311a302f13/matplotlib-3.8.3.tar.gz
...
%prep
%setup -q -n matplotlib-3.8.3
cd %{_builddir}/matplotlib-3.8.3
pushd ..
cp -a matplotlib-3.8.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1708012213
