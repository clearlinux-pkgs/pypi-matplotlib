...
Source0  : https://files.pythonhosted.org/packages/b4/1b/1b80fcc6b7f33a4c7fa025e944416f8b63fa8d278fad32470c82a2edf319/matplotlib-3.8.1.tar.gz
...
%prep
%setup -q -n matplotlib-3.8.1
cd %{_builddir}/matplotlib-3.8.1
pushd ..
cp -a matplotlib-3.8.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1698852424
